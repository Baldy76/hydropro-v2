...
window.completeCycle = () => {
    if(!confirm("🚀 Start a new month? All cleaned status will be reset!")) return;
...
window.renderWeekLists = () => { /* Logic preserved */ };
window.renderStats = () => { /* Logic preserved */ };
window.renderLedger = () => { /* Logic preserved */ };
